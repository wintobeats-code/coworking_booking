...
from sqlalchemy import ForeignKey, String, Integer, Time, Date, UniqueConstraint, Enum as SAEnum
...
class User(Base):
    ...
    role: Mapped[str] = mapped_column(SAEnum(UserRole, name='user_role', create_constraint=True), default=UserRole.EMPLOYEE, nullable=False)
...
class Booking(Base):
    ...
    slot_id: Mapped[int] = mapped_column(ForeignKey("slot.id"), nullable=False)
